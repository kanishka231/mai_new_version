...
class Audio_B extends  StatefulWidget {
  @override
  State<Audio_B> createState() => _Audio_BState();
}
class _Audio_BState extends State<Audio_B> {

  int maxduration = 100;
  int currentpos = 0;
  String currentpostlabel = "00:00";
  String audioasset = "assets/audio/khand_B(maa_ka_dudh).mp3";
