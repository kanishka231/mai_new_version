...
class Audio_F extends  StatefulWidget {
  @override
  State<Audio_F> createState() => _Audio_FState();
}
class _Audio_FState extends State<Audio_F> {

  int maxduration = 100;
  int currentpos = 0;
  String currentpostlabel = "00:00";
  String audioasset = "assets/audio/khand_F_tikaakaran.mp3";
