...
class Audio_C extends  StatefulWidget {
  @override
  State<Audio_C> createState() => _Audio_CState();
}
class _Audio_CState extends State<Audio_C> {

  int maxduration = 100;
  int currentpos = 0;
  String currentpostlabel = "00:00";
  String audioasset = "assets/audio/khand_C(navjaat dekhbhal).mp3";
