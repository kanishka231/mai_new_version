...
class Audio_D extends  StatefulWidget {
  @override
  State<Audio_D> createState() => _Audio_DState();
}
class _Audio_DState extends State<Audio_D> {

  int maxduration = 100;
  int currentpos = 0;
  String currentpostlabel = "00:00";
  String audioasset = "assets/audio/khand_D_maa_ki_dekhbhal.mp3";
